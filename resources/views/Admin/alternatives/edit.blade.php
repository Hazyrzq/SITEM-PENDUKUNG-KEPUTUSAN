...
<div class="content-wrapper">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-primary text-white py-3">
            <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Edit Alternatif: {{ $alternative->name }}</h4>
        </div>
        <div class="card-body p-4">
            <form action="{{ route('admin.alternatives.update', $alternative) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4">{{ old('description', $alternative->description) }}</textarea>
